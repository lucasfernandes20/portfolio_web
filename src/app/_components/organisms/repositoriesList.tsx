...
export function RepositoriesList() {
  ...
  return (
    <div className="[&>*:nth-child(n)]:hidden [&>:nth-child(-n+3)]:flex tablet:[&>*:nth-child(n)]:flex w-full flex flex-col tablet:grid tablet:auto-cols-max tablet:grid-cols-3 gap-3">
